<style scoped>
    ...
    #index_pc_bj{width:100%;height:80%;background-size:cover;overflow: hidden;background-image: url(../images/bss.jpg);background-position:center center;box-shadow: 0 0px 3px rgba(0,0,0,.5);text-align: center;}
    /*具体内容*/
    ...
    <div class="index">
        <div style="height: 10%; vertical-align: middle;">
            <div style="float: left; margin-left: 10%;    margin-top: 20px;">
                <img alt="LOGO" src="../images/logop.png">
            </div>
            <div style="float: right; margin-right: 10%; font-size: 24px; margin-top: 30px;">正品正源网络科技有限公司</div>
        </div>
        <div id="index_pc_bj">
        ...
        <div style="height: 10%; text-align: center;">
            <div style="margin-top: 30px;">Copyright©2015.正品正源网络科技有限公司All
                right reserved.京ICP备00000001号</div>
        </div>
    </div>
</template>
<script>
    export default {
        ...
        methods: {
            login(formLogin){
                this.$refs[formLogin].validate((valid) => {//验证
                    if(valid){
                        //这里跳转到UsersModule.js中的userLogin方法
